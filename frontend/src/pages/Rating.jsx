...
function Rating() {
  ...
  return (
    <div className="relative w-[100%] min-h-screen overflow-hidden pb-[200px]">
      ...
      {listType === "friends" &&
      <div className="relative w-[89.74%] mt-[4.66%] mx-[5.13%] flex items-center justify-between">
      ...
      <div className="relative w-[89.74%] mt-[4.66%] mx-[5.13%] flex items-center justify-between">
        <div className="relative cursor-pointer" onClick={() => setListType("friends")}>
          <div className="uppercase font-[600] text-[18px] leading-[21.6px] text-[rgba(255,255,255,.3)] text-center">Мои друзья</div>
        </div>
        <div className="relative cursor-pointer">
          <div className="uppercase font-[600] text-[18px] leading-[21.6px] text-white text-center">Участники</div>
          <div className="absolute bottom-[-4px] h-[2px] w-[100%] bg-[#25E9FF]" style={{clipPath: 'polygon(0% 0%, 100% 0%, 98.113% 100%, 1.887% 100%)'}}></div>
        </div>
      </div>}
